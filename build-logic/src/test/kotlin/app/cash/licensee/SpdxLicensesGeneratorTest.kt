...
class SpdxLicensesGeneratorTest {
  ...
  fun httpUrlGetsHttpsVariant() {
    ...
    assertThat(spdxLicenses.findByUrl("http://example.com/foo"))
      .isNotNull()
      .containsExactly(
        SpdxLicenseJson(
          "FOO-1.0",
    ...
    assertThat(spdxLicenses.findByUrl("https://example.com/foo"))
      .isNotNull()
      .containsExactly(
        SpdxLicenseJson(
          "FOO-1.0",
    ...
    assertThat(spdxLicenses.findByUrl("https://example.com/bar"))
      .isNotNull()
      .containsExactly(
        SpdxLicenseJson(
          "BAR-1.0",
  ...
  fun spdxUrlSupported() {
    ...
    assertThat(spdxLicenses.findByUrl("https://spdx.org/licenses/FOO-1.0.html"))
      .isNotNull()
      .containsExactly(
        SpdxLicenseJson(
          "FOO-1.0",
  ...
  fun spdxUrlFallback() {
    ...
    val json =
      ...
      |"""
        .trimMargin()
    val spdxLicenses = SpdxLicenses.parseJson(json) {}
    assertThat(spdxLicenses.findByIdentifier("FOO-1.0"))
      .isEqualTo(
        SpdxLicenseJson(
          "FOO-1.0",
          "Foo License",
    ...
    assertThat(spdxLicenses.findByIdentifier("BAR-1.0"))
      .isEqualTo(
        SpdxLicenseJson(
          "BAR-1.0",
          "Bar License",
  ...
  fun customUrlFallback() {
    ...
    assertThat(spdxLicenses.findByUrl("https://example.org/bar"))
      .isNotNull()
      .containsExactly(bar1, bar2)
    assertThat(spdxLicenses.simplified)
      .containsExactly(
